...
public class DFSVisitor<L> {
	 ...
	 * predecessore. Ogni volta che un nodo viene visitato viene eseguito il metodo
	 * visitNode sul nodo. In questa classe il metodo non fa niente, basta creare
	 * una sottoclasse e ridefinire il metodo per eseguire azioni particolari.
	 * 
	 ...
	 * visitati durante la DFS nel momento in cui il colore passa da grigio a nero.
